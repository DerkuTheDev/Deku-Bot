...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    .setColor("#2f3136")
    .setDescription(`<a:loading:717795161513656340> Generating a owl pic!...`)
    let msg = await message.channel
      .send(loadingEmbed)
      .then(m => m.delete({ timeout: 2000 }));

    fetch("https://www.reddit.com/r/Owls.json?sort=top&t=daily")
      .then(res => res.json())
      .then(body => {
...
console.log(`${message.author.username}#${message.author.discriminator} asked for a owl pic!`)
